...
//                     <p><b>Aim : </b>My Team developed a comprehensive tourism discovery website designed to assist travelers in finding the best and trending destinations with valuable tips and seasonal visit recommendations. The website is an all-in-one resource that helps tourists plan unforgettable journeys with ease and confidence.</p>
//                     <p><b>Team : </b>Lakshmi Sai Sigatapu, divya, Nandini, Ragu, siva gangadhar, bargav</p>
//                     <p><b>Technologies use: </b> HTML & CSS, JavaScript for development and AWS for Clonig web</p>
//                     <div className={mystyles.probut}>
//                         <a href="https://sivagangadharthecoder.github.io/travel_tale_final/index.html" target="_blank"><button>View Project</button></a>
//                     </div>
//                     </div>
//                 </div>
//             </div>
